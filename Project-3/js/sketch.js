...
function setup(){
    ...
    const clientHeight = document.getElementById('p5').clientHeight;
    //half width since logo does not occupy entire space
    const clientWidth = document.getElementById('p5').clientWidth;

    const myCanvas = createCanvas(500,clientHeight) ;
    myCanvas.parent('p5') ;
...
function draw() {
    //stop after 3000 frames. Prevents memory hog
    if (frameCount <= 3000) {
